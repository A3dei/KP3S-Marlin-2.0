...
#define STRING_CONFIG_H_AUTHOR "(Antonio.D / For GitHUB A3_dei)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "KP3s BMG"
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_FEEDRATE          { 160, 140, 5, 90 }
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_ACCELERATION      { 1500, 1250, 100, 2500 }
...
#define LEVEL_BED_CORNERS
  ...
  #define LEVEL_CORNERS_INSET_LFRB { 22, 24, 24, 16 } // (mm) Left, Front, Right, Back insets
...
#define NOZZLE_PARK_POINT { (X_MIN_POS + 15), (Y_MIN_POS + 5), 4 }
